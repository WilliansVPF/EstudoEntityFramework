...
public class AppDbContext : DbContext
{
    ...
    public DbSet<Endereco> Enderecos => Set<Endereco>(); //? como a tabela de cliente ja faz referencia a endereço, não é obrigatorio essa declaração, porem, para fazer busca direto na tabela de endereço, é necessaria essa declaração
